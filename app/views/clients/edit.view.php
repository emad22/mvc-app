  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="form-group col-xs-6">
            ...
            <input class="form-control" required type="text" name="Name" maxlength="40" value="<?= $this->showValue('Name', $client) ?>"">
        </div>
        <div class="form-group col-xs-6">
            <label<?= $this->labelFloat('Email', $client) ?>><?= $text_label_Email ?></label>
            <input class="form-control" required type="email" name="Email" maxlength="40" value="<?= $this->showValue('Email', $client) ?>">
        </div>
        <div class="form-group col-xs-6">
            <label<?= $this->labelFloat('PhoneNumber' ,$client) ?>><?= $text_label_PhoneNumber ?></label>
            <input class="form-control" required type="text" name="PhoneNumber" maxlength="15" value="<?= $this->showValue('PhoneNumber', $client) ?>">
        </div>
        <div class="form-group col-xs-6">
            <label<?= $this->labelFloat('Address', $client) ?>><?= $text_label_Address ?></label>
            <input class="form-control" required type="text" name="Address" value="<?= $this->showValue('Address', $client) ?>">
        </div>
    </div>
                 <!-- /.box-body -->
